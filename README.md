...
- Alison: Kerry Lawrynovicz's [Girls' Day Out](https://collection.eliterature.org/1/works/lawrynovicz__girls_day_out.html)
...
- Chantelle: Lou Garcia-Dolnik's [No-Face](https://rundog.art/poetry/no-face-lou-garcia-dolnik/)
- Madeleine: Young-Hae Chang Heavy Industries's [The Art of Sleep (Insomniac Version)](https://www.yhchang.com/THE_ART_OF_SLEEP_INSOMNIAC_VERSION_V.html)
...
- Kathryn: Brian Kim Stefans's [The Dreamlife of Letters](https://collection.eliterature.org/1/works/stefans__the_dreamlife_of_letters.html)
...
There is no recording for this week's class. I briefly covered the requirements for the developed creative work which will be due at the end of week 12. The rest of the class was given over to giving feedback on the works-in-progress.
